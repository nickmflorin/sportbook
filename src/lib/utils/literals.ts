...
export type LiteralsAccessor<V extends string> = types.SpacesToUnderscores<types.HyphensToUnderscores<Uppercase<V>>>;
...
type EnumeratedLiteralsAssertion<V extends readonly VI[], VI extends string = string> = (
  value: unknown,
 ...
 */
export type EnumeratedLiterals<V extends readonly VI[], VI extends string = string> = EnumeratedLiteralsConstants<
  V,
  VI
> & {
